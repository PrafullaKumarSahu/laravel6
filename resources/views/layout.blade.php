	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li class="{{ Request::path() == 'posts' ? 'current_page_item': ''}}"><a href="{{ route('posts.index') }}" accesskey="4" title="">Posts</a></li>
...
<div id="wrapper">
  ...
  <div id="copyright" class="container">
        ...
        <link href="{{ asset('js/app.js') }}" rel="stylesheet" type="text/css" media="all" />
</body>
</html>
